...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 1226;
    private static final int ACTION_DRINKING_PENDING_INTENT_ID = 2200;
    private static int WATER_REMINDER_PENDING_INTENT_ID = 5147;
    private static int WATER_REMINDER_NOTIFICATION_ID = 3158;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        builder.setLargeIcon(largeIcon(context)).setSmallIcon(R.drawable.ic_drink_notification)
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(
                context,
                ACTION_DRINKING_PENDING_INTENT_ID,
                drinkWaterIntent,
                PendingIntent.FLAG_UPDATE_CURRENT
        );
