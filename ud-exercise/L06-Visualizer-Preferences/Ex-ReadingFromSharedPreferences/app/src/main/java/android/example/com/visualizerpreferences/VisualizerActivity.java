...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowMid(getResources().getBoolean(R.bool.pref_show_mid_range_default));
        mVisualizerView.setShowTreble(getResources().getBoolean(R.bool.pref_show_treble_default));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if(key.equalsIgnoreCase(getString(R.string.pref_show_bass_key))) {
            mVisualizerView.setShowBass(sharedPreferences.getBoolean(getString(R.string.pref_show_bass_key), true));
        } else if(key.equalsIgnoreCase(getString(R.string.pref_show_mid_range_key))) {
            mVisualizerView.setShowBass(sharedPreferences.getBoolean(getString(R.string.pref_show_mid_range_key), true));
        }else if(key.equalsIgnoreCase(getString(R.string.pref_show_treble_key))) {
            mVisualizerView.setShowBass(sharedPreferences.getBoolean(getString(R.string.pref_show_treble_key), true));
        } else if(key.equalsIgnoreCase(getString(R.string.pref_color_key))){
            loadColorFromPreferences(sharedPreferences);
        } else if(key.equalsIgnoreCase(getString(R.string.pref_size_key))){
            loadSizeFromSharedPreferences(sharedPreferences);
        }
    }
