...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent activityThatStartedIntent = getIntent();
        ...
        if(activityThatStartedIntent.hasExtra(Intent.EXTRA_TEXT)){
            String msg = activityThatStartedIntent.getStringExtra(Intent.EXTRA_TEXT);
            mDisplayText.setText(msg);
        }
